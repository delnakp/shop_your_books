<x-admin-layout>
  ...
  <div class="tab-content" id="myTabContent">
    <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
      ...
      <form action="{{route('admin.updateProduct', $book->id)}}" method="POST" class="row g-3">@csrf
      ...
      <div class="row mt-4">
              ...
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="product_code"  value="{{$book->product_code}}">
                @error('product_code')
                  <span class="text-danger"> {{ $message }}</span>
                @enderror
              </div>
      ...
      <div class="row mt-2">
              <div class="col-md-6">
                ...
                <input class="form-check-input" type="checkbox" name="hide" value="1" @if($book->hide) ? checked @endif>
                <br />
